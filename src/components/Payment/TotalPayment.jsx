        ...
        <div className='w-full bg-white py-3 px-4 rounded-lg shadow-lg'>
            ...
            <div className='flex gap-2 justify-between mt-4'>
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="text" id="counter-input" data-input-counter class="flex-shrink-0 border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value="0" required />
