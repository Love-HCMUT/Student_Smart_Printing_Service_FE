...
const PaymentPage = () => {
    ...
    const confirmTransaction = async () => {
        ...
        try {
            const response = await axios.post(`${host}/payment/momo`, data, { headers });
    ...
    return (
        <div className='justify-center w-lvw min-h-screen bg-light-gray flex gap-10'>
            ...
            <div className='mb-[40px] mt-[50px] w-1/2p-4 flex flex-col items-center gap-6'>
                ...
                <p className="px-2 self-start text-left">Double click to remove combo</p>
            ...
            <div className='mb-[40px] mt-[80px] w-1/5 flex flex-col gap-5 items-center'>
                <TotalPayment combo={cart} putitem={putItem} removeitem={removeItem} decreaseitem={decreaseItem} />

                <div className='w-full flex justify-center items-center'>
                    <button
                        onClick={async () => confirmTransaction()}
                        type="button" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Confirm transaction
                    </button>
                </div>
            </div>
