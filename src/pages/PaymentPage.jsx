            ...
            <div className='mb-[40px] mt-[80px] w-1/5 flex flex-col gap-5 items-center'>
                ...
                <div className='w-full flex justify-center items-center'>
                    <button
                        ...
                        type="button" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Confirm transaction
                    </button>
                </div>
            </div>
